...
NBodyPartBunch::NBodyPartBunch(const std::vector<OpalParticle> &rhs,
    ...
    PartBunch(rhs, ref)
{
    std::cout << "\n!!!DAVID> NBodyPartBunch(const std::vector<OpalParticles> &rhs, const Par$
              << std::endl;
}
...
void NBodyPartBunch::computeSelfFields(int binNumber) {
    std::cout << "\n!!!DAVID> not yet implemented: NBodyPartBunch::computeSelfFields(int binN$
              << std::endl;
}

void NBodyPartBunch::computeSelfFields() {
    IpplTimings::startTimer(selfFieldTimer_m);
    std::cout << "\n!!!DAVID>Yay, Reached: NBodyPartBunch::computeSelfFields(){\n" << std::en$
    IpplTimings::stopTimer(selfFieldTimer_m);
}


void NBodyPartBunch::computeSelfFields_cycl(double gamma) {
    std::cout << "\n!!!DAVID> not yet implemented: NBodyPartBunch::computeSelfFields_cycl(dou$
              << std::endl;
}

void NBodyPartBunch::computeSelfFields_cycl(int bin) {
    std::cout << "\n!!!DAVID> not yet implemented: NBodyPartBunch::computeSelfFields_cycl(int$
              << std::endl;
}
