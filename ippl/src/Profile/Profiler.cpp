...
#ifdef PROFILE_CALLS
	ExclInclCallList = new std::list<std::pair<double, double> >();
#endif //PROFILE_CALLS
...
{
	ExclInclCallList->push_back(std::pair<double,double>(ex,in));
	return 1;
}
...
int Profiler::StoreData()
{
	...
	std::list<std::pair<double,double> >::iterator iter;
#endif // PROFILE_CALLS
