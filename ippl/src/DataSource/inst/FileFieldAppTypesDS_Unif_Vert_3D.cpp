...
template class FileFieldDataSource<Vektor<IPPL_PRECISION_TYPE,3U>, 3U,
                                   UniformCartesian<3U,IPPL_PRECISION_TYPE>,
                                   Vert>;
...
/***************************************************************************
 * $RCSfile: FileFieldAppTypesDS_Unif_Vert_3D.cpp,v $   $Author: adelmann $
 * $Revision: 1.1.1.1 $   $Date: 2003/01/23 07:40:25 $
 * IPPL_VERSION_ID: $Id: FileFieldAppTypesDS_Unif_Vert_3D.cpp,v 1.1.1.1 2003/01/23 07:40:25 adelmann Exp $ 
 ***************************************************************************/
