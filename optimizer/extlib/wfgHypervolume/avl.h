...
extern avl_node_t *avl_insert_before(avl_tree_t *, avl_node_t *old, avl_node_t *n);
...
extern avl_node_t *avl_insert_after(avl_tree_t *, avl_node_t *old, avl_node_t *n);
...
extern avl_node_t *avl_fixup_node(avl_tree_t *, avl_node_t *n);
